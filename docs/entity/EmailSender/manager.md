## Railken\Amethyst\Managers\EmailSenderManager
...
Create the new manager in `app/Managers/EmailSenderManager`
```php
class Railken\Amethyst\Managers\EmailSenderManager as Manager;
...
return [
    'data' => [
        'email-sender' => [
            'manager' => App\Managers\EmailSenderManager::class,
        ],
    ]
];
```
